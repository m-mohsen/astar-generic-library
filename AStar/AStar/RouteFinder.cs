    ...
    public class RouteFinder
    {
        ...
        public void AddGoal(Location goal)
        {
            ...
            if (goal == InitialLocation)
                throw new InvalidOperationException("The goal location has the same location of the initial location.");

            foreach (Location obstacleLoc in obstacles)
            {
                if (goal == obstacleLoc)
                    throw new InvalidOperationException("The goal location has the same location of a previously added obstacle.");
            }
        ...
        public void AddObstacle(Location obstacle)
        {
            ...
            if (obstacle == InitialLocation)
                throw new InvalidOperationException("The obstacle location has the same location of the initial location.");

            foreach (Location goalLoc in goalLocations)
            {
                if (obstacle == goalLoc)
                    throw new InvalidOperationException("The obstacle location has the same location of a previously added goal.");
            }
